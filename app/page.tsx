      ...
      <main>
        <section className="hero">
          ...
          <div className="shell hero-content">
            <div className="hero-copy">
              ...
              <h1>البيت المحمي<br /><em>يبدأ من العزل الصح.</em></h1>
              <p>نحمي منزلك من تسربات المياه وحرارة الصيف بحلول عزل مائي وحراري احترافية، بخامات معتمدة وتنفيذ دقيق وضمان مكتوب.</p>
        ...
        <section className="proof-strip" aria-label="مميزات العازل للعزل الحديث">
          <div className="shell proof-grid">
            <div><small>خبرة</small><strong>+15</strong><span>عامًا من الخبرة</span></div>
            <div><small>جاهزية</small><strong>24/7</strong><span>استقبال الطلبات</span></div>
            <div><small>ثقة</small><strong>100%</strong><span>خامات معتمدة</span></div>
            <div><small>نطاقنا</small><strong>حائل</strong><span>تغطية جميع الأحياء</span></div>
          </div>
        </section>

        <section className="section shell" id="services">
          <div className="section-heading split-heading">
            <div><span className="eyebrow">01 / خدماتنا</span><h2>حلول عزل لكل مساحة</h2></div>
        ...
        <section className="section shell process">
          <div className="section-heading center"><span className="eyebrow">03 / كيف نعمل؟</span><h2>من المعاينة إلى الضمان</h2><p>خطوات واضحة تضمن دقة التنفيذ وتوفر عليك الوقت والتكلفة.</p></div>
        ...
        <section className="work-section section" id="work">
          <div className="shell"><div className="section-heading work-heading"><div><span className="eyebrow light">02 / من أرض الواقع</span><h2>نماذج من أعمالنا</h2></div><p>صور حقيقية من مراحل التنفيذ والمعالجة في مواقع عمل مختلفة.</p></div>
        ...
        <section className="section shell faq" id="faq">
          <div className="faq-intro"><span className="eyebrow">05 / أسئلة شائعة</span><h2>إجابات قبل أن تبدأ</h2><p>لو عندك سؤال آخر، تواصل معنا وسنساعدك في اختيار الحل الأنسب لموقعك.</p><a href={`tel:${phone}`} className="text-link"><bdi>{phone}</bdi> تحدث معنا</a></div>
